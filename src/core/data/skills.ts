...
export const SKILLS: readonly Skill[] = [
  ...
  // ─── 丐幫專屬 ───
  {
    id: 'gaibang_dog',
    name: '打狗棒法',
    description: '丐幫幫主絕學，棒法精妙，剛柔並濟。',
    reqLevel: 6,
    cost: 420,
    passive: { gen: 5, shen: 4 },
    damageMultiplier: 0.65,
    sectId: 'gaibang',
  },
  {
  ...
  // ─── 明教專屬 ───
  {
    id: 'mingjiao_qiankun',
    name: '乾坤大挪移',
    description: '明教鎮教神功，借力打力，深不可測。',
    reqLevel: 10,
    cost: 850,
    passive: { nei: 9, shen: 4 },
    damageMultiplier: 0.7,
    sectId: 'mingjiao',
  },
  {
